      ...
      Odyssey updates in your inbox.</p>
      {
        ...
        <div className='mt-6 lg:max-w-[45.3125rem] lg:mx-auto lg:mt-16 lg:relative'>
          <div className='p-[1px] rounded-md bg-gradient-to-r from-primaryGradient-light to-primaryGradient-dark shadow-[0px_4px_10px_3px_#0000001C] relative'>
            ...
            {mutatation.isPending && <Icon icon="line-md:loading-loop" className='text-3xl text-primaryGradient-light absolute top-1/2 -translate-y-1/2 right-4 lg:right-56'  />}
          </div>
          <div className='mt-6 flex justify-center items-center lg:absolute lg:w-fit lg:h-fit lg:-top-2 lg:mt-0 lg:right-4 ' onClick={subscribe} >
            <ResponsiveImage 
              alt='subscribe'
              width={225}
              height={94}
